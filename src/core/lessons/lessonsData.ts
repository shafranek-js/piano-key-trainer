...
export const LESSONS: readonly LessonDef[] = [
  ...
  {
    id: 'bass-clef-intro',
    title: 'Урок 11 · Басовый ключ',
    tag: 'Басовый ключ',
    summary: 'Учимся читать ноты для левой руки: опоры F3 (4-я линейка), C3 (2-й промежуток) и C4.',
    steps: [
      { type: 'info', title: 'Басовый ключ · Ключ Фа', body: 'Басовый ключ (F-clef) используется для левой руки. Две точки ключа охватывают 4-ю линейку снизу — это нота Фа малой октавы (F3).' },
      { type: 'exact', note: 'F', keyId: 'F3', title: 'Опора F3 (4-я линейка)', body: 'Нажми F3 (Фа малой октавы). Она соответствует 4-й линейке басового стана.' },
      { type: 'info', title: 'Басовое До (C3)', body: 'Вторая главная опора — До малой октавы (C3). На басовом стане она лежит во 2-м промежутке снизу (между 2-й и 3-й линейками).' },
      { type: 'exact', note: 'C', keyId: 'C3', title: 'Басовое До · C3', body: 'Нажми C3 (До малой октавы). Это основа C-позиции левой руки.' },
      { type: 'exact', note: 'C', keyId: 'C4', title: 'Middle C (C4) на добавочной', body: 'Нота C4 лежит на первой добавочной линейке сверху над басовым станом. Нажми C4.' },
      { type: 'complete', title: 'Басовый стан освоен', body: 'Теперь ты знаешь главные ориентиры басового стана: F3 (4-я линейка), C3 (2-й промежуток) и C4 (добавочная сверху).' }
    ]
  },
  {
    id: 'grand-staff-intro',
    title: 'Урок 12 · Двойной нотный стан (Grand Staff)',
    tag: 'Две руки',
    summary: 'Связываем скрипичный и басовый ключи в единую систему с центром на Middle C.',
    steps: [
      { type: 'info', title: 'Система двух станов', body: 'Фортепианная музыка пишется на двойном стане (Grand Staff), объединяющем скрипичный (сверху) и басовый (снизу) ключи фигурной скобкой (акколадой).' },
      { type: 'exact', note: 'C', keyId: 'C4', title: 'Центр системы · Middle C (C4)', body: 'C4 находится ровно посередине между двумя станами на добавочной линейке. Нажми C4.' },
      { type: 'exact', note: 'G', keyId: 'G4', title: 'Правая рука · Соль первой (G4)', body: 'Вторая линейка скрипичного ключа. Нажми G4 правой рукой.' },
      { type: 'exact', note: 'F', keyId: 'F3', title: 'Левая рука · Фа малой (F3)', body: 'Четвёртая линейка басового ключа. Нажми F3 левой рукой.' },
      { type: 'complete', title: 'Полный Grand Staff готов', body: 'Обе руки объединены на двойном стане. Теперь ты готов читать ноты в обеих октавах!' }
    ]
  }
];
